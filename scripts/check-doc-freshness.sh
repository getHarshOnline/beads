...
DOCS=(
    ...
    "engdocs/LINTING.md|.golangci.yml;scripts/ci/pr-lint.sh;Makefile;.github/FORK-AUTOMATION-POLICY.md"
    "engdocs/CI_CLEANUP_PLAN.md|engdocs/CI_TEST_SURFACE_AUDIT.md;.github/FORK-AUTOMATION-POLICY.md;.buildflags;.golangci.yml;scripts/ci/pr-lint.sh;Makefile"
